       ...
       <div className="bg-white animate-in slide-in-from-right-4 duration-200">
          <div className="flex justify-between items-center mb-6 border-b border-slate-100 pb-4">
             ...
             <div className="flex gap-2">
                ...
                <button onClick={() => setView('LIST')} className="px-4 py-2 text-sm bg-orange-600 text-white rounded-lg hover:bg-orange-700">Save</button>
             </div>
          </div>
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4 mb-6">
         ...
         <div className="flex items-center gap-3">
            ...
            <button onClick={handleCreate} className="flex items-center gap-2 px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 shadow-sm font-medium text-sm transition-colors">
          ...
          <div key={item.id} className="group bg-white rounded-xl border border-slate-200 overflow-hidden hover:border-orange-200 hover:shadow-md transition-all">
            ...
            <div className="p-5">
               ...
               <div className="flex justify-between items-center pt-4 border-t border-slate-50">
                  ...
                  <div className="flex gap-2">
                     <button className="p-1.5 text-slate-400 hover:text-orange-600 transition-colors"><Edit2 size={16}/></button>
