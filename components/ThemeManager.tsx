      ...
      <div className="bg-white animate-in fade-in duration-300">
        <div className="flex justify-between items-center mb-6 border-b border-slate-100 pb-4">
          ...
          <div className="space-x-3">
            ...
            <button 
              onClick={handleSave}
              className="px-4 py-2 text-sm bg-brand-600 text-white rounded-lg hover:bg-brand-700 shadow-sm transition-colors font-medium"
            >
              Save Theme
            </button>
          </div>
        ...
        {/* Simplified Form for brevity in this view */}
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4 mb-6">
         ...
         <div className="flex items-center gap-3">
            ...
            <button 
               ...
               className="flex items-center gap-2 px-4 py-2 bg-brand-500 text-white rounded-lg hover:bg-brand-600 shadow-sm font-medium text-sm"
            >
                ...
                <tr key={theme.id} className="hover:bg-slate-50 transition-colors bg-white">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end gap-2 text-slate-400">
                       <button onClick={() => { setCurrentTheme(theme); setIsEditing(true); }} className="hover:text-brand-600 transition-colors">
                         <Edit2 size={16} />
                       </button>
